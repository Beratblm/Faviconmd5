#Author: Berat mlb
#favicon database tool shows which hash fits which database
#You need to get the md5 value of the favicon using the curl tool.
import argparse
import colorama


def search_hash(value):
    favicon_hash = {"6399cc480d494bf1fcd7d16c42b1c11b": "penguin",
    ...
    return favicon_hash.get(value, "not found")     


if __name__ == "__main__":
    args = argparse.ArgumentParser()
    args.add_argument("hash", help="add md5 hash value")
    args = args.parse_args()


    value = search_hash(args.hash)
    print(colorama.Fore.RED, "Database:",colorama.Fore.GREEN,value)
